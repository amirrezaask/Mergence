import { collectWrappedTerminalLinkLine, extractTerminalLinks } from "../terminal-links.js";
import {
  GhosttyTerminalCore,
...
const TERMINAL_GLYPH_FALLBACKS = `"${NERD_FONT_FAMILY}", monospace`;
// Keep the default stack concrete enough for Canvas font shorthand while
// reusing the appearance system's bundled text face and symbol fallback.
export const DEFAULT_TERMINAL_FONT_FAMILY =
  `"${DEFAULT_MONO_FONT_NAME}", ${TERMINAL_GLYPH_FALLBACKS}`;
